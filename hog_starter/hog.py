...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    # Problem 2
    # free bacon. if Player 1 has 42 points, Player 0 gains 1 + max(4, 2) = 5
    if num_rolls == 0:
...
def select_dice(score, opponent_score):
    ...
    # Problem 3
    # Hog wild.
    # If the sum of both players' total scores is a multiple of seven (e.g., 14, 21, 35),
    # then (return) the current player rolls four-sided dice instead of the usual 
    # (else return) six-sided dice.
...
def is_swap(score0, score1):
    """Return Ture if score0 is score1's double or score1 is score2's double.
    Example 1: Player 0 has 20 points and Player 1 has 5; it is Player 1's turn.
    She scores 5 more, bringing her total to 10. The players swap scores:
    Player 0 now has 10 points and Player 1 has 20.
    """
...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    while score < goal and opponent_score < goal:
        ...
        if who == 0:           
            ...
            # print("num_rolls ", num_rolls, score, opponent_score)          
        else:
...
def max_scoring_num_rolls(dice=six_sided):
    ...
    while number_of_dice <= 10:
        current_roll = make_averaged(roll_dice, num_samples=1000)(number_of_dice, dice)
        if current_roll > max_roll:
            max_roll = current_roll
            max_number_of_dice = number_of_dice
        print(number_of_dice, "dice scores", max_roll, "on average")
        number_of_dice += 1
...
def bacon_strategy(score, opponent_score):
    ...
    0
    """
    # which returns 0 whenever rolling 0 would give at least BACON_MARGIN points 
    # and returns BASELINE_NUM_ROLLS 
    # otherwise (these two global variables are located right above the 
    # always_roll function
...
def swap_strategy(score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    # Problem 8 
    bacon = 1 + max(opponent_score // 10, opponent_score % 10)
    score_with_bacon = score + bacon
    if is_swap(score_with_bacon, opponent_score):
...
def final_strategy(score, opponent_score):
    ...
    The expected score of rolling a 4-sided dice is about 3.797.
    This strategy get an average win rate greater than 0.55.
